    ...
    <div className="min-h-dvh bg-surface-page text-text-primary">
      ...
      <main className="mx-auto max-w-2xl px-4 py-10 md:px-6 md:py-14">
        ...
        <div className="mt-5 space-y-4 font-sans text-[0.88rem] leading-[1.55] text-text-secondary">
          ...
          <p>
            It does <span className="text-text-primary">not store or log</span> any of these, and
            there is no database. The Lab is <span className="text-text-primary">cookieless</span>{' '}
            and uses privacy-friendly, GDPR-aligned analytics to count aggregate page views, with no
            cookies and no personal data collected. The only client-side storage is your browser’s{' '}
